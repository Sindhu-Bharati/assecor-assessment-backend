...
class PersonapiApplicationTests {
	...
	//@BeforeAll
	//void setup() {
		//this.csvFileHandler= new CsvFileHandler(inputFilePath);
		
		//ReflectionTestUtils.setField(getClass(), inputFilePath, REST_TEMPLATE);
	//}
...
@Test
	...
	void contextLoads2() {
		...
		assertEquals(expectedPerson, response.getBody().get(0));
